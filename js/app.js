...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "Muhilak jud ko run😭";
    yes.style.height = "80%";
    yes.style.width = "80%";
    ...
    text.innerHTML = "Dili ka maluoy sako?🥺😘";
    yes.style.height = "90%";
    yes.style.width = "96%";
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "Kabalo jud ko kalipay ko nimo 😘";
  yes.innerHTML = '<a href="https://www.instagram.com/uhlyn.a?igsh=eWN0eDV2d3ExenVx">CHAT DAYUN SA</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
